...
import { getBuATheme, getBuBTheme } from '../packages/themes/src';
...
const sideBySideDecorator = (Story: React.ComponentType) => {
	...
	return (
		<div style={{ display: 'flex', gap: '24px', padding: '24px' }}>
			<div style={{ flex: 1, border: '1px solid #e0e0e0', padding: '16px', borderRadius: '8px' }}>
				<div style={{ marginBottom: '16px', fontWeight: 'bold', color: '#666' }}>BU A</div>
				<ThemeProvider theme={buATheme}>
					<Story />
				</ThemeProvider>
			</div>
			<div style={{ flex: 1, border: '1px solid #e0e0e0', padding: '16px', borderRadius: '8px' }}>
				<div style={{ marginBottom: '16px', fontWeight: 'bold', color: '#666' }}>BU B</div>

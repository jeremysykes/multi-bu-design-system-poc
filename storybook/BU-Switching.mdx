...
2. **Select a Theme**: Click the dropdown to choose from:
   - **Core Banking Platform** 🏦 - Conservative, dense, professional
   - **Growth & Payments Experience** 🚀 - Expressive, spacious, modern
   - **Wealth Management** 💎 - Sophisticated, premium, elegant
...
Chromatic visual regression testing captures snapshots for all three BU themes:

- Each story is tested under all three themes
